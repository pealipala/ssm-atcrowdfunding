...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">众筹平台 - 项目标签添加</a></div>
        </div>
                ...
                <div class="panel-body">
                    <form id="addForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="ficon" placeholder="请输入标签图标">
